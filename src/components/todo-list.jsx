  ...
  function TodoList({newData, deleteItem, handleMoreList, haveData}) {
    return (
      <div>
        ...
        {haveData && <div className="flex justify-center my-5"><Button onClick={handleMoreList} variant="ghost">More view</Button></div>}
      </div> 
    )
  }
